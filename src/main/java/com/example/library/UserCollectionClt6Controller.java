...
public class UserCollectionClt6Controller extends UserController implements UserCollectionCltController {
    ...
    public void showCollectionData(ActionEvent actionEvent) throws IOException {
        ...
        Task<List<Book>> loadBooksTask = new Task<>() {
            ...
            protected List<Book> call() throws Exception {
                ...
                return BookService.getBooksFromKeywords(6, isMostRecent, isMostAdded, isMostView);
            }
        };
