...
public class UserJDBC {
    ...
    public static boolean nameUpdate(String username, String name) {
    ...
    public static boolean securityQuestionsUpdate(String username, String ques1, String ques2, String ques3) {
        String query = "UPDATE `users` SET ques1 = ?, ques2 = ?, ques3 = ? WHERE username = ?";
        try (Connection databaseConnect = connect(); PreparedStatement sqlStatement = databaseConnect.prepareStatement(query)) {
